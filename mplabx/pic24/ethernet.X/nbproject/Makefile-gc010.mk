...
SOURCEFILES_QUOTED_IF_SPACED="TCPIP Stack/Announce.c" "TCPIP Stack/ARCFOUR.c" "TCPIP Stack/ARP.c" "TCPIP Stack/AutoIP.c" "TCPIP Stack/BerkeleyAPI.c" "TCPIP Stack/BigInt.c" "TCPIP Stack/Delay.c" "TCPIP Stack/DHCP.c" "TCPIP Stack/DHCPs.c" "TCPIP Stack/DNS.c" "TCPIP Stack/DNSs.c" "TCPIP Stack/DynDNS.c" "TCPIP Stack/ENC28J60.c" "TCPIP Stack/ENCX24J600.c" "TCPIP Stack/ETH97J60.c" "TCPIP Stack/FileSystem.c" "TCPIP Stack/FTP.c" "TCPIP Stack/Hashes.c" "TCPIP Stack/Helpers.c" "TCPIP Stack/HTTP2.c" "TCPIP Stack/ICMP.c" "TCPIP Stack/IP.c" "TCPIP Stack/LCDBlocking.c" "TCPIP Stack/MPFS2.c" "TCPIP Stack/NBNS.c" "TCPIP Stack/Random.c" "TCPIP Stack/Reboot.c" "TCPIP Stack/RSA.c" "TCPIP Stack/SMTP.c" "TCPIP Stack/SNMP.c" "TCPIP Stack/SNMPv3.c" "TCPIP Stack/SNMPv3USM.c" "TCPIP Stack/SNTP.c" "TCPIP Stack/SPIEEPROM.c" "TCPIP Stack/SPIFlash.c" "TCPIP Stack/SPIRAM.c" "TCPIP Stack/SSL.c" "TCPIP Stack/StackTsk.c" "TCPIP Stack/TCP.c" "TCPIP Stack/TCPPerformanceTest.c" "TCPIP Stack/Telnet.c" "TCPIP Stack/TFTPc.c" "TCPIP Stack/Tick.c" "TCPIP Stack/UART.c" "TCPIP Stack/UART2TCPBridge.c" "TCPIP Stack/UDP.c" "TCPIP Stack/UDPPerformanceTest.c" "TCPIP Stack/ZeroconfHelper.c" "TCPIP Stack/ZeroconfLinkLocal.c" "TCPIP Stack/ZeroconfMulticastDNS.c" main.c CustomHTTPApp.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED="${OBJECTDIR}/TCPIP Stack/Announce.o" "${OBJECTDIR}/TCPIP Stack/ARCFOUR.o" "${OBJECTDIR}/TCPIP Stack/ARP.o" "${OBJECTDIR}/TCPIP Stack/AutoIP.o" "${OBJECTDIR}/TCPIP Stack/BerkeleyAPI.o" "${OBJECTDIR}/TCPIP Stack/BigInt.o" "${OBJECTDIR}/TCPIP Stack/Delay.o" "${OBJECTDIR}/TCPIP Stack/DHCP.o" "${OBJECTDIR}/TCPIP Stack/DHCPs.o" "${OBJECTDIR}/TCPIP Stack/DNS.o" "${OBJECTDIR}/TCPIP Stack/DNSs.o" "${OBJECTDIR}/TCPIP Stack/DynDNS.o" "${OBJECTDIR}/TCPIP Stack/ENC28J60.o" "${OBJECTDIR}/TCPIP Stack/ENCX24J600.o" "${OBJECTDIR}/TCPIP Stack/ETH97J60.o" "${OBJECTDIR}/TCPIP Stack/FileSystem.o" "${OBJECTDIR}/TCPIP Stack/FTP.o" "${OBJECTDIR}/TCPIP Stack/Hashes.o" "${OBJECTDIR}/TCPIP Stack/Helpers.o" "${OBJECTDIR}/TCPIP Stack/HTTP2.o" "${OBJECTDIR}/TCPIP Stack/ICMP.o" "${OBJECTDIR}/TCPIP Stack/IP.o" "${OBJECTDIR}/TCPIP Stack/LCDBlocking.o" "${OBJECTDIR}/TCPIP Stack/MPFS2.o" "${OBJECTDIR}/TCPIP Stack/NBNS.o" "${OBJECTDIR}/TCPIP Stack/Random.o" "${OBJECTDIR}/TCPIP Stack/Reboot.o" "${OBJECTDIR}/TCPIP Stack/RSA.o" "${OBJECTDIR}/TCPIP Stack/SMTP.o" "${OBJECTDIR}/TCPIP Stack/SNMP.o" "${OBJECTDIR}/TCPIP Stack/SNMPv3.o" "${OBJECTDIR}/TCPIP Stack/SNMPv3USM.o" "${OBJECTDIR}/TCPIP Stack/SNTP.o" "${OBJECTDIR}/TCPIP Stack/SPIEEPROM.o" "${OBJECTDIR}/TCPIP Stack/SPIFlash.o" "${OBJECTDIR}/TCPIP Stack/SPIRAM.o" "${OBJECTDIR}/TCPIP Stack/SSL.o" "${OBJECTDIR}/TCPIP Stack/StackTsk.o" "${OBJECTDIR}/TCPIP Stack/TCP.o" "${OBJECTDIR}/TCPIP Stack/TCPPerformanceTest.o" "${OBJECTDIR}/TCPIP Stack/Telnet.o" "${OBJECTDIR}/TCPIP Stack/TFTPc.o" "${OBJECTDIR}/TCPIP Stack/Tick.o" "${OBJECTDIR}/TCPIP Stack/UART.o" "${OBJECTDIR}/TCPIP Stack/UART2TCPBridge.o" "${OBJECTDIR}/TCPIP Stack/UDP.o" "${OBJECTDIR}/TCPIP Stack/UDPPerformanceTest.o" "${OBJECTDIR}/TCPIP Stack/ZeroconfHelper.o" "${OBJECTDIR}/TCPIP Stack/ZeroconfLinkLocal.o" "${OBJECTDIR}/TCPIP Stack/ZeroconfMulticastDNS.o" ${OBJECTDIR}/main.o ${OBJECTDIR}/CustomHTTPApp.o
