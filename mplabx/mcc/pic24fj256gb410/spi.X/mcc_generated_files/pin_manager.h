...
/**
  ...
  @Example
    <code>
    // Set RD1 high (1)
    DRDY_ADS1256_SetHigh();
    </code>

*/
#define DRDY_ADS1256_SetHigh()          _LATD1 = 1
/**
  @Summary
...
*/
#define DRDY_ADS1256_SetLow()           _LATD1 = 0
/**
  @Summary
...
*/
#define DRDY_ADS1256_Toggle()           _LATD1 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RD1
    postValue = DRDY_ADS1256_GetValue();
    </code>

*/
#define DRDY_ADS1256_GetValue()         _RD1
/**
  @Summary
  ...
  @Example
    ...
    DRDY_ADS1256_SetDigitalInput();
    </code>

*/
#define DRDY_ADS1256_SetDigitalInput()  _TRISD1 = 1
/**
  @Summary
  ...
  @Example
    ...
    DRDY_ADS1256_SetDigitalOutput();
    </code>

*/
#define DRDY_ADS1256_SetDigitalOutput() _TRISD1 = 0
/**
  @Summary
...
*/
#define LEMP_ENABLE_SetHigh()          _LATE3 = 1
/**
  @Summary
...
*/
#define LEMP_ENABLE_SetLow()           _LATE3 = 0
/**
  @Summary
...
*/
#define LEMP_ENABLE_Toggle()           _LATE3 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RE3
    postValue = LEMP_ENABLE_GetValue();
    </code>

*/
#define LEMP_ENABLE_GetValue()         _RE3
/**
  @Summary
  ...
  @Example
    ...
    LEMP_ENABLE_SetDigitalInput();
    </code>

*/
#define LEMP_ENABLE_SetDigitalInput()  _TRISE3 = 1
/**
  @Summary
  ...
  @Example
    ...
    LEMP_ENABLE_SetDigitalOutput();
    </code>

*/
#define LEMP_ENABLE_SetDigitalOutput() _TRISE3 = 0
/**
  @Summary
...
*/
#define CSWITCH_SetHigh()          _LATG13 = 1
/**
  @Summary
...
*/
#define CSWITCH_SetLow()           _LATG13 = 0
/**
  @Summary
...
*/
#define CSWITCH_Toggle()           _LATG13 ^= 1
/**
  @Summary
...
*/
#define CSWITCH_SetDigitalInput()  _TRISG13 = 1
/**
  @Summary
...
*/
#define CSWITCH_SetDigitalOutput() _TRISG13 = 0
/**
  @Summary
...
*/
#define DSWITCH_SetHigh()          _LATG14 = 1
/**
  @Summary
...
*/
#define DSWITCH_SetLow()           _LATG14 = 0
/**
  @Summary
...
*/
#define DSWITCH_Toggle()           _LATG14 ^= 1
/**
  @Summary
...
*/
#define DSWITCH_SetDigitalInput()  _TRISG14 = 1
/**
  @Summary
...
*/
#define DSWITCH_SetDigitalOutput() _TRISG14 = 0
