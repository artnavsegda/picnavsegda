...
// *******************************************************************
// PIC18F46K20 Starter Kit Demo Board Lesson 9 - Internal Oscillator
//
// This lesson demonstrates changing the speed of the microcontroller
// clock using hte internal clock block from 125kHz to 32MHz.
//
// *******************************************************************
...
void main (void)
{
  // Init I/O
    ...
    // Set initial clock speed (125kHz)
...
{   // This function sets the internal oscillator to the frequency of
    ...
    switch (*ClockSet)
    {
        ...
        case C_16MHz:
            ...
            OSCTUNEbits.PLLEN = 1;  // x4 PLL enabled = 16MHz
            *ClockSet = C_32MHz;
            SwitchDelay = 128;
            break;

        case C_32MHz:
            OSCCON = 0x70;          // IRCFx = 111 (8 MHz)
