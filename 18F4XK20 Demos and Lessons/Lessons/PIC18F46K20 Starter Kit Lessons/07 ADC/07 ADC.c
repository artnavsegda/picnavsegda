...
// *******************************************************************
// PIC18F46K20 Starter Kit Demo Board Lesson 7 - ADC
//
// This lesson uses the Analog-to-Digital-Converter on the PIC18LF4520
// convert the potentiometer voltage on pin RA0 to a value used
...
{ // initialize the Analog-To-Digital converter.
    ...
    // as the demo board potentiometer is connected to RE0/AN5
    ...
    // This also sets bits VCFG1 and VCFG0 so the ADC voltage reference is VSS to VDD
    ...
    // written TAD minimum for the PIC18LF4520 is 1.4us.
    ...
    // Select channel 5 (AN5) to read the potentiometer voltage and turn on ADC
    ADCON0 = 0b00010101;
}
