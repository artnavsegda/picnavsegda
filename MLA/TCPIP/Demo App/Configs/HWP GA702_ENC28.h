...
// ENC28J60 I/O pins
#define ENC_CS_TRIS			(TRISDbits.TRISD6)
#define ENC_CS_IO			(LATDbits.LATD6)
...
#define ENC_SPICON1			(SPI1CON1H)
#define ENC_SPICON1bits		(SPI1CON1Hbits)
#define ENC_SPICON2			(SPI1CON2H)
